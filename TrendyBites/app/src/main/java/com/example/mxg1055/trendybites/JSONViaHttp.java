...
public class JSONViaHttp {
     ...
     * @param payload a String containing the body of the request Note that this payload should be URL-encoded
     * @return a url connection that can be used to get the response
     */
    public static String get(String method, String sURL, QueryStringParams queryString, String payload) {
     ...
     *
     */
    private static HttpURLConnection makeRequest(String method, String sURL, QueryStringParams queryString, String payload) {
    ...
    private static String getResponse(HttpURLConnection urlConnection) {
        ...
        try {
            ...
            if (responseCode != 200) {
                Log.e(TAG, "Request for '" + urlConnection.getURL() + "' return response code: " + responseCode);
                return null;
            }
        }
        catch (IOException e) {
        ...
        //try {
            ...
            Log.d("JSONViaHttp",json.toString());
